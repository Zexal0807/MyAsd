<?php
/*
	This class is my personal rework of FPDF Class, I didn't create it from zero, I copied FPDF Class and modified its
...
*******************************************************************************/
	...
	function __construct($width = null, $height = null, $unit = null, $orientation = null){
    if(!isset($width)){
      $width  = "210";
    }
    if(!isset($height)){
  ...
  public function addRotatedText($ang, $x, $y, $txt){
    $this->rotate($ang, $x, $x);
	...
	public function Cell($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = false, $link = ''){
		// Output a cell
		$k = $this->k;
		if($this->y + $h > $this->PageBreakTrigger && !$this->InHeader && !$this->InFooter && $this->getAutoPageBreak()){
			// Automatic page break
			$x = $this->x;
			$ws = $this->ws;
			if($ws>0){
	...
	public function save($dest = '', $name = '', $isUTF8 = false){
	...
	*******************************************************************************/
	...
	{
		$this->metadata['Producer'] = 'ZPdf - from FPDF';
