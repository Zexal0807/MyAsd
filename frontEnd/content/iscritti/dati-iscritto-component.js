export class DatiIscrittoComponent extends ZexalComponent {
	...
	_addEvent() {
		...
		$(".data", this).append(new ExamTableComponent(this._exam));
	}
...
class ExamTableComponent extends CustomTableComponent {
	_name = "Esami";
